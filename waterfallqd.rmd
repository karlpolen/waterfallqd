...
ans.pe=waterfall(dmat.pe,ret=seq(1,30,.1),invcost=peinv,capital=pecap)
```
...
ans.re=waterfall(dmat.re,ret=seq(1,30,.1),invcost=reinv,capital=recap)
```
